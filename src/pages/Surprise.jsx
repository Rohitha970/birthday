...
export default function Surprise() {
  ...
  /* =======================
     ...
     ======================= */
  const fullText =
    "Mom, your love has always been my silent strength and my strongest support. " +
    ...
    <div className="surprise">
      ...
      <button className="voice-btn center-btn" onClick={toggleAudio}>
        <span className="btn-text">
          {isPlaying ? "⏸ The day the world became brighter.💖" : "▶ Today is special, because you are 💖"}
        </span>
      </button>
      ...
      <div className="bottom-section">
        ...
        >
          <img src="/assets/images/gift.jpeg" alt="Gift" />
        </motion.div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
        >
          <img src="/assets/images/birth.jpeg" alt="Mom" />
        </motion.div>

        <motion.div className="bottom-item qr-wrapper" onClick={handleQRClick}>
